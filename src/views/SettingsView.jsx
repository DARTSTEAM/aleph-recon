    ...
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
      ...
      <Section title="Integrations" icon={Link}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
          ...
          <Field label="Inbound Email Domain" stateKey="inboundEmailDomain" value={cfg.inboundEmailDomain || 'alephholding.com, alephdigital.com, abndigital.com.ar'} onChange={setField} />
        </div>
      </Section>
